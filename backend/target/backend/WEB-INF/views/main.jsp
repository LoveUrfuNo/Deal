                                                ...
                                                <form id="logoutForm" method="POST" action="${contextPath}/logout">
                                                    ...
                                                    <ul>
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            <a class="col-xs-6 col-sm-6 col-md-6 col-lg-3 col-lg-push-0" href="#"><i class="fa fa-envelope-open-o fa-3x" aria-hidden="true"></i></a>
                                                            <a class = "col-xs-2 col-xs-push-4 col-sm-2 col-sm-push-4 col-md-6 col-md-push-0 col-lg-3 col-lg-push-3" href="#"><i class="fa fa-user-o fa-3x" aria-hidden="true"></i></a>
                                                        </div>
                                                    </ul>
