...
<form class="ui form">
    <div class="field">
        ...
        <input type="text" name="first-name" placeholder="Сигна">
    </div>
    <div class="field">
        <select class="ui fluid search dropdown" name="">
            <option value="">Категория</option>
            <option value="1">1 категория</option>
            <option value="1">2 категория</option>
            <option value="2">3 категория</option>
        </select>
    </div>
    <div class="field">
        <label>Описание услуги</label>
        <textarea maxlength="3000" rows="4"></textarea>
    </div>
    <div class="field">
    ...
    <div class="ui selection dropdown">
        ...
        <div class="menu">
            <div class="item" data-value="male" data-text="VIP">
                <i class="smile icon"></i>
                VIP
            </div>
            <div class="item" data-value="female" data-text="Обычный">
