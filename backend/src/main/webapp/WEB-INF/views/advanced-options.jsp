...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/advanced-options.css">
    <title>Advanced Options</title>

</head>
<body>
<div class="advanced-options">
    <form method="POST" action="${contextPath}/options" class="ui form">
        <div class="field">
            <label>Имя</label>
        ...
        <div class="field">
            ...
            <div class="ui selection dropdown">
                ...
                <div class="menu">
                    ...
                    <div class="item" data-value="0">Женский</div>
                </div>
            </div>
        </div>
        ...
        <div class="three fields">
            ...
            <div class="field">
                ...
                <input type="text" name="first-name" placeholder="Год рождения">
            </div>
        </div>
        <div class="field">
            <label>Country</label>
...
<script src="${pageContext.request.contextPath}/resources/js/advanced-options.js"></script>
</body>
</html>
